...
class ManageAppUsersComponent extends React.Component {
  ...
  render() {
    ...
    const embeddableLink = `<iframe width="560" height="315" src="${appLink}${this.props.slug}" title="Easiio Sflow app - ${this.props.slug}" frameborder="0" allowfullscreen></iframe>`;
