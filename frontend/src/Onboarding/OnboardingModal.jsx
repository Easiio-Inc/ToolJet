      ...
      >
        <Modal.Header>
          <Modal.Title className="text-center">
            {this.props.t('onBoarding.finishToolJetInstallation', 'Finish sflow.io Dashboard installation')}
          </Modal.Title>
          <br />
        </Modal.Header>
        ...
        <Modal.Body>
          ...
          <small>
            {this.props.t(
              ...
              'You will receive updates from the sflow team ( 1-2 emails every month, we do not spam )'
            )}
          </small>
        </Modal.Body>
